...
const experiences = [
  ...
  },
  {
    ...
    period: "2023 - 2024",
    description: "Gestão de equipes e resolução de conflitos. Experiência que fortaleceu minhas Soft Skills de liderança, comunicação e organização, essenciais para gestão de projetos de TI.",
    skills: ["Liderança", "Gestão de Equipes", "Comunicação"],
    icon: Briefcase,
  },
]
